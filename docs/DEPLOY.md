...
The app builds and runs **without** a database. Progress is stored in the browser. Questions load from `data/questions.json`.

## Production checklist

- [ ] `npm run import:check` on the bank you ship
- [ ] Images present under `public/media/` for every `imageUrl`
